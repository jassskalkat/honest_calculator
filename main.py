# honest_calculator is a user-friendly program to perform basic arithmetic calculations.
# The result can be saved to memory if the user wants to use it in future calculations.

# messages dictionary to call messages with indexes
...
# start --> end (the flowchart implemented is provided)
while True:
